...
Once you are logged in.Got to [My apps](https://developer.safaricom.co.ke/MyApps) and click on the `CREATE NEW APP` button.
...
```json
{
    "MerchantRequestID": "92215-25754101-1",
...
```
## Acknowledgement
Special thanks to [Peter Njeru](https://peternjeru.co.ke/) for the awesome [documentation](https://peternjeru.co.ke/safdaraja/ui/) of the daraja api 